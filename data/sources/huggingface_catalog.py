...
HF_DATASETS = {
    "pretraining_fsnaix": HuggingFaceDatasetSource(
        ...
        url="https://huggingface.co/datasets/fsnaix/vietnamese-corpus-large",
    ...
    "pretraining_tuan_nt": HuggingFaceDatasetSource(
        dataset_id="Tuan-NT/vietnamese-corpus-pretrain",
        url="https://huggingface.co/datasets/Tuan-NT/vietnamese-corpus-pretrain",
        dataset_type="pre_training",
        split="train",
        local_path=(
            r"C:\DATA\AIDATA\raw\external"
    ...
    "instruction_sft_10k": HuggingFaceDatasetSource(
        ...
        url=(
            ...
            "522H0134-NguyenNhatHuy/vietnamese-sft-10k"
        ),
    ...
    "instruction_merged": HuggingFaceDatasetSource(
        ...
        url=(
            "https://huggingface.co/datasets/"
            "BlossomsAI/merged_vietnamese_instruction_dataset"
        ),
        dataset_type="instruction",
        split="train",
        local_path=(
    ...
    "conversation_alpaca": HuggingFaceDatasetSource(
        ...
        local_path=(
            r"C:\DATA\AIDATA\raw\external"
            r"\conversation\vietnamese_multi_turn_chat_alpaca"
        ),
        license="apache-2.0",
    ),
    ...
    "emotion_vsmec": HuggingFaceDatasetSource(
        ...
        url="https://huggingface.co/datasets/visolex/UIT-VSMEC",
    ...
    "preference_vi_srs": HuggingFaceDatasetSource(
        ...
        url="https://huggingface.co/datasets/NLPLab-SoICT/Vi-SRS",
    ...
    "evaluation_vmmu": HuggingFaceDatasetSource(
        ...
        url="https://huggingface.co/datasets/anvo25/vmmu",
        dataset_type="multimodal",
        split="full_vqa",
        local_path=(
            r"C:\DATA\AIDATA\raw\external"
